...
FREQ_DIST_FILE = './processed_train_data-freqdist.pkl'
BI_FREQ_DIST_FILE = './processed_train_data-freqdist-bi.pkl'
TRAIN_PROCESSED_FILE = './processed_train_data.csv'
TEST_PROCESSED_FILE = './processed_test_data.csv'
...
# python cnn.py
# Test:
# python cnn.py <model_path>
# Predict:
# python cnn.py <model_path> --predict <sentence>
